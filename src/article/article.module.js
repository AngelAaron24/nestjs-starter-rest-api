...
var article_acl_service_1 = require("./services/article-acl.service");
var ArticleModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [shared_module_1.SharedModule, typeorm_1.TypeOrmModule.forFeature([article_entity_1.Article]), user_module_1.UserModule],
            providers: [
    ...
    var _classThis;
    var ArticleModule = _classThis = /** @class */ (function () {
        function ArticleModule_1() {
        }
        return ArticleModule_1;
    }());
    __setFunctionName(_classThis, "ArticleModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ArticleModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ArticleModule = _classThis;
}();
