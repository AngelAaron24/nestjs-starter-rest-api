...
var Article = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('articles')];
    ...
    (function () {
        ...
        _post_decorators = [(0, typeorm_1.Column)()];
        _createdAt_decorators = [(0, typeorm_1.CreateDateColumn)({ name: 'createdAt' })];
        _updatedAt_decorators = [(0, typeorm_1.UpdateDateColumn)({ name: 'updatedAt' })];
        _author_decorators = [(0, typeorm_1.ManyToOne)(function () { return user_entity_1.User; }, function (user) { return user.articles; }, {
                eager: true,
            })];
