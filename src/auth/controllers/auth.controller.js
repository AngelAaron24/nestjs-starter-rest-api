...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.refreshToken = function (ctx, credential) {
            return __awaiter(this, void 0, void 0, function () {
                var authToken;
                return __generator(this, function (_a) {
                    switch (_a.label) {
    ...
    (function () {
        ...
        _login_decorators = [(0, common_1.Post)('login'), (0, swagger_1.ApiOperation)({
            ...
            }), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, common_1.UseGuards)(local_auth_guard_1.LocalAuthGuard), (0, common_1.UseInterceptors)(common_1.ClassSerializerInterceptor)];
        _registerLocal_decorators = [(0, common_1.Post)('register'), (0, swagger_1.ApiOperation)({
                summary: 'User registration API',
            }), (0, swagger_1.ApiResponse)({
                status: common_1.HttpStatus.CREATED,
                type: (0, base_api_response_dto_1.SwaggerBaseApiResponse)(auth_register_output_dto_1.RegisterOutput),
            })];
        _refreshToken_decorators = [(0, common_1.Post)('refresh-token'), (0, swagger_1.ApiOperation)({
                ...
                status: common_1.HttpStatus.UNAUTHORIZED,
                type: base_api_response_dto_1.BaseApiErrorResponse,
            }), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, common_1.UseGuards)(jwt_refresh_guard_1.JwtRefreshGuard), (0, common_1.UseInterceptors)(common_1.ClassSerializerInterceptor)];
        ...
        __esDecorate(_classThis, null, _registerLocal_decorators, { kind: "method", name: "registerLocal", static: false, private: false, access: { has: function (obj) { return "registerLocal" in obj; }, get: function (obj) { return obj.registerLocal; } }, metadata: _metadata }, null, _instanceExtraInitializers);
