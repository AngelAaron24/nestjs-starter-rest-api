...
var UserAclService = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _classSuper = acl_service_1.BaseAclService;
    var UserAclService = _classThis = /** @class */ (function (_super) {
        __extends(UserAclService_1, _super);
        function UserAclService_1() {
        ...
        UserAclService_1.prototype.isUserItself = function (resource, actor) {
            return resource.id === actor.id;
        };
        return UserAclService_1;
    }(_classSuper));
    __setFunctionName(_classThis, "UserAclService");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        UserAclService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserAclService = _classThis;
}();
